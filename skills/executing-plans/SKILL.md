...
- **suprapowers:using-git-worktrees** - Ensures isolated workspace (creates one or verifies existing)
- **suprapowers:writing-plans** - Creates the plan this skill executes
